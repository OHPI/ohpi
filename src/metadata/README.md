 ...
 * [ohpi.yml](ohpi.yml)
     * Determines how your purl.obolibrary.org/obo/ohpi/ redirects will be handled
     ...
     * Paste in the contents of [ohpi.yml](ohpi.yml)
 ...
 * [ohpi.md](ohpi.md)
     ...
     * Paste in the contents of [ohpi.md](ohpi.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
